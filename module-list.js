(function(){
    var modules={
        ...
        "neurovosa-b-post-nback2-data":		        {url:"$H/m/neurocog/nback2-block-data.html",Table:"neurovosa-b-post-nback2",form_module:"neurovosa-b-post-nback2-form"},
        "neurovosa-b-post-nback2-form":		        {url:"$H/m/neurocog/nback2-block-form.html",Table:"neurovosa-b-post-nback2",task_name:"2 Back"},
        "neurovosa-b-post-stroop-text-data":		    {url:"$H/m/neurocog/stroop-text-block-data.html",Table:"neurovosa-b-post-stroop-text",form_module:"neurovosa-b-post-stroop-text-form"},
        "neurovosa-b-post-stroop-text-form":		    {url:"$H/m/neurocog/stroop-text-block-form.html",Table:"neurovosa-b-post-stroop-text",task_name:"Stroop Text"},
        "neurovosa-b-post-stroop-colour-data":		{url:"$H/m/neurocog/stroop-colour-block-data.html",Table:"neurovosa-b-post-stroop-colour",form_module:"neurovosa-b-post-stroop-colour-form"},
        "neurovosa-b-post-stroop-colour-form":		{url:"$H/m/neurocog/stroop-colour-block-form.html",Table:"neurovosa-b-post-stroop-colour",task_name:"Stroop Colour"},
        ...
        "neurovosa-3m-post-nback2-data":		        {url:"$H/m/neurocog/nback2-block-data.html",Table:"neurovosa-3m-post-nback2",form_module:"neurovosa-3m-post-nback2-form"},
        "neurovosa-3m-post-nback2-form":		        {url:"$H/m/neurocog/nback2-block-form.html",Table:"neurovosa-3m-post-nback2",task_name:"2 Back"},
        "neurovosa-3m-post-stroop-text-data":		    {url:"$H/m/neurocog/stroop-text-block-data.html",Table:"neurovosa-3m-post-stroop-text",form_module:"neurovosa-3m-post-stroop-text-form"},
        "neurovosa-3m-post-stroop-text-form":		    {url:"$H/m/neurocog/stroop-text-block-form.html",Table:"neurovosa-3m-post-stroop-text",task_name:"Stroop Text"},
        "neurovosa-3m-post-stroop-colour-data":		    {url:"$H/m/neurocog/stroop-colour-block-data.html",Table:"neurovosa-3m-post-stroop-colour",form_module:"neurovosa-3m-post-stroop-colour-form"},
        "neurovosa-3m-post-stroop-colour-form":		    {url:"$H/m/neurocog/stroop-colour-block-form.html",Table:"neurovosa-3m-post-stroop-colour",task_name:"Stroop Colour"},
        ...
        "neurovosa-b-pre-word-pairs-set1-data":	        {url:"$H/m/library/word-pairs-data.html",Table:"neurovosa-b-post-word-pairs-set1",form_module:"neurovosa-b-pre-word-pairs-set1-form"},
        "neurovosa-b-pre-word-pairs-set1-form":	        {url:"$H/m/library/word-pairs-form.html",Table:"neurovosa-b-post-word-pairs-set1"},
        ...
        "neurovosa-b-post-word-pairs-set1-data":        {url:"$H/m/library/word-pairs-data.html",Table:"neurovosa-b-post-word-pairs-set1",form_module:"neurovosa-b-post-word-pairs-set1-form"},
        "neurovosa-b-post-word-pairs-set1-form":        {url:"$H/m/library/word-pairs-form.html",Table:"neurovosa-b-post-word-pairs-set1"},
        ...
        "neurovosa-3m-pre-word-pairs-set1-data":		{url:"$H/m/library/word-pairs-data.html",Table:"neurovosa-3m-post-word-pairs-set1",form_module:"neurovosa-3m-pre-word-pairs-set1-form"},
        "neurovosa-3m-pre-word-pairs-set1-form":		{url:"$H/m/library/word-pairs-form.html",Table:"neurovosa-3m-post-word-pairs-set1"},
        ...
        "neurovosa-3m-post-word-pairs-set1-data":		{url:"$H/m/library/word-pairs-data.html",Table:"neurovosa-3m-post-word-pairs-set1",form_module:"neurovosa-3m-post-word-pairs-set1-form"},
        "neurovosa-3m-post-word-pairs-set1-form":		{url:"$H/m/library/word-pairs-form.html",Table:"neurovosa-3m-post-word-pairs-set1"},
